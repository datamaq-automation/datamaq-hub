"""Gateway for querying Tecpetrol / Techint career and talent opportunities."""
...
DEFAULT_TECHINT_CAREERS_URL = "https://careers.techint.com/career"
DEFAULT_USER_AGENT = (
...
class TecpetrolTalentGateway(PortalEmpleoPort):
    """Implementación del puerto PortalEmpleoPort para el portal de talento de Tecpetrol / Techint."""

    def __init__(
        self,
        base_url: str = DEFAULT_TECHINT_CAREERS_URL,
    ...
    def buscar_ofertas(
        ...
        """Consulta ofertas en el portal de Tecpetrol y las mapea al dominio."""
        headers = {
    ...
    def _parsear_resultados(self, data: dict[str, Any]) -> list[OfertaLaboral]:
        ...
        for item in items:
            ...
            oferta = OfertaLaboral(
                id_oferta=f"tec-{req_id}" if req_id else f"tec-{hash(titulo)}",
                titulo=titulo,

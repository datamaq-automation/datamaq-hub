"""DTOs (Data Transfer Objects) con validación Pydantic v2 para horarios de docencia."""
...
class CargoDocenteDTO(BaseModel):
    """DTO para un cargo o espacio curricular docente."""

    model_config = ConfigDict(extra="forbid")

    id_cargo: str = Field(
        description="Identificador único del cargo o secuencia (ej. 'CARGO-01')"
    )
...
class DeclaracionHorariaInputDTO(BaseModel):
    """DTO de entrada para auditar una declaración jurada horaria docente."""
